...
#Get the cholesky decomposition, or the sqrt of our covariance matrix
#This way, we can have the equivalent of the standard deviation,
#Since variance = stddev^2 -> stddev = sqrt(variance)
print C
